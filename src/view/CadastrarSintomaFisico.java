...
import model.SintomaFisico.LocalCorpo;
import model.SintomaFisico.NomeSintomaFisico;
...
public class CadastrarSintomaFisico extends JFrame implements ActionListener {
	...
	private JComboBox <NomeSintomaFisico> nomeSintoma = new JComboBox<>();
	private JComboBox <LocalCorpo> localSintoma = new JComboBox<>();
	...
	public CadastrarSintomaFisico ()
	{
		...
		nomeSintoma.setModel(new DefaultComboBoxModel<>(NomeSintomaFisico.values()));
		...
		localSintoma.setModel(new DefaultComboBoxModel<>(LocalCorpo.values()));
