...
public class TelaEditarUsuaria {
	...
	public JTextField txtNascimento;
	...
	public void initialize() {
		...
		JLabel tituloRG = new JLabel("Data de nascimento:");
		...
		txtNascimento.setBounds(46, 348, 335, 20);
		...
		check.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String msgErro = control.verificaCadastro(txtNome.getText(), txtEmail.getText(), txtNascimento.getText(),
				...
				if (msgErro.length() > 0) {
					...
					Dados.getPessoas().get(Dados.getPessoas().indexOf(TelaLoging.usuariaLogada)).editarDados(
							txtNome.getText(), txtEmail.getText(), txtNascimento.getText(),
							TelaLoging.usuariaLogada.getSenha());
